  ...
  public: {
    Tables: {
      ...
      image_ids: {
        ...
        Relationships: [
          {
            foreignKeyName: "image_ids_scouting_response_fkey"
            columns: ["scouting_response"]
            isOneToOne: false
            referencedRelation: "scouting_responses"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "image_ids_team_fkey"
            columns: ["team"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
